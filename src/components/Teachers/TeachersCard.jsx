...
const TeachersCard = ({ teacher }) => {
  ...
  return (
    <div className="p-3 lg:p-5 shadow-lg rounded-md ">
      ...
      <Link
        to={`/teachers/${_id}`}
        className="p-6 w-[150px] h-[44px] text-center text-[14px] rounded-xl border-[1px] border-solid border-[#fbbaab]  mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none hover:text-white"
      >
        Book Appointment
      </Link>
    </div>
